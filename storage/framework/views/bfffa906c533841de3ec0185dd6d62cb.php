        ...
        <div class="container mx-auto px-4">
            ...
            <?php if($galeris->count() > 0): ?>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4" x-data="{
                    ...
                    currentTitle: '',
                    currentIndex: 0,
                    images: <?php echo e(json_encode($galeris->where('tipe', 'foto')->map(fn($g) => ['url' => Storage::url($g->file_path), 'title' => $g->judul])->values())); ?>,
                        ...
                        <div class="group relative aspect-square overflow-hidden rounded-xl bg-gray-100" data-aos="fade-up"
                            ...
                            <?php if($galeri->tipe === 'foto'): ?>
                                ...
                                <div class="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition flex items-center justify-center cursor-pointer"
                                    @click="openLightbox('<?php echo e(Storage::url($galeri->file_path)); ?>', '<?php echo e($galeri->judul); ?>', <?php echo e($fotoIndex); ?>)">
                                    <div class="opacity-0 group-hover:opacity-100 transition text-white text-center px-4">
                                        <i class="fas fa-expand text-3xl mb-2"></i>
                                        <p class="font-medium line-clamp-2"><?php echo e($galeri->judul); ?></p>
                                    </div>
                                </div>
                                <?php $fotoIndex++; ?>
                            <?php else: ?>
                                <?php if($galeri->youtube_url): ?>
                                    <a href="<?php echo e($galeri->youtube_url); ?>" target="_blank" class="block w-full h-full">
                                        <img src="https://img.youtube.com/vi/<?php echo e($galeri->youtube_video_id); ?>/maxresdefault.jpg"
                                ...
                                <?php elseif($galeri->file_path): ?>
                                    <video class="w-full h-full object-cover">
                                        <source src="<?php echo e(Storage::url($galeri->file_path)); ?>" type="video/mp4">
                                    </video>
                            ...
                            <?php if($galeri->kategori): ?>
                                <div class="absolute top-2 left-2">
                                    <span
                                        class="px-2 py-1 bg-white/90 text-gray-700 text-xs font-medium rounded"><?php echo e($galeri->kategori->nama); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
