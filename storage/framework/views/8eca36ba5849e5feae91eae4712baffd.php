...
<?php $__env->startSection('title', 'Data Stunting - Infografis'); ?>
    ...
    <section class="relative py-20 bg-gradient-to-r from-red-600 to-red-700">
        <div class="container mx-auto px-4">
            <div class="text-center text-white">
                ...
                <p class="text-lg text-red-100">Infografis Stunting <?php echo e($profil->nama_desa ?? 'Desa Tanalum'); ?></p>
            </div>
        </div>
    </section>
    ...
    <section class="py-8 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="bg-white rounded-xl shadow-sm p-8">
                ...
                <?php if(isset($stuntingData) && count($stuntingData) > 0): ?>
                    <!-- Summary Cards -->
                    <div class="grid md:grid-cols-4 gap-4 mb-8">
                        <div class="bg-green-50 rounded-xl p-6 text-center">
                            <p class="text-gray-600 mb-2">Total Balita</p>
                            <p class="text-3xl font-bold text-green-600"><?php echo e($totalBalita ?? 0); ?></p>
                        </div>
                        <div class="bg-red-50 rounded-xl p-6 text-center">
                            <p class="text-gray-600 mb-2">Stunting</p>
                            <p class="text-3xl font-bold text-red-600"><?php echo e($totalStunting ?? 0); ?></p>
                        </div>
                        <div class="bg-yellow-50 rounded-xl p-6 text-center">
                            <p class="text-gray-600 mb-2">Risiko Stunting</p>
                            <p class="text-3xl font-bold text-yellow-600"><?php echo e($risikoStunting ?? 0); ?></p>
                        </div>
                        <div class="bg-blue-50 rounded-xl p-6 text-center">
                            <p class="text-gray-600 mb-2">Prevalensi</p>
                            <p class="text-3xl font-bold text-blue-600"><?php echo e($prevalensi ?? '0%'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody class="divide-y">
                                <?php $__currentLoopData = $stuntingData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-4 py-3"><?php echo e($index + 1); ?></td>
                                        <td class="px-4 py-3"><?php echo e($data->nama); ?></td>
                                        <td class="px-4 py-3"><?php echo e($data->usia); ?> bulan</td>
                                        <td class="px-4 py-3">
                                            <span
                                                class="px-2 py-1 rounded-full text-xs font-medium 
                                            <?php echo e($data->status == 'normal' ? 'bg-green-100 text-green-700' : ''); ?>

                                            <?php echo e($data->status == 'risiko' ? 'bg-yellow-100 text-yellow-700' : ''); ?>

                                            <?php echo e($data->status == 'stunting' ? 'bg-red-100 text-red-700' : ''); ?>">
                                                <?php echo e(ucfirst($data->status)); ?>

                                            </span>
                                        </td>
                                        <td class="px-4 py-3 text-gray-600"><?php echo e($data->keterangan ?? '-'); ?></td>
                                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-desa-tanalum\resources\views/infografis/stunting.blade.php ENDPATH**/ ?>