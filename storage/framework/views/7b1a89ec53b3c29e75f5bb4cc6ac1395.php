                ...
                <div class="bg-white rounded-xl shadow-sm">
                    ...
                    <div class="p-6">
                        ...
                        <div x-show="activeTab === 'umum'" class="space-y-6">
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="nama_desa" id="nama_desa"
                                        value="<?php echo e(old('nama_desa', $profil->nama_desa ?? '')); ?>" required
                                ...
                                <div>
                                    ...
                                    <input type="text" name="kode_desa" id="kode_desa"
                                        value="<?php echo e(old('kode_desa', $profil->kode_desa ?? '')); ?>"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                </div>
                            </div>
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="kecamatan" id="kecamatan"
                                        value="<?php echo e(old('kecamatan', $profil->kecamatan ?? 'Marang Kayu')); ?>"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                </div>
                                <div>
                                    <label for="kabupaten"
                                    ...
                                    <input type="text" name="kabupaten" id="kabupaten"
                                        value="<?php echo e(old('kabupaten', $profil->kabupaten ?? 'Kutai Kartanegara')); ?>"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                </div>
                            </div>
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="provinsi" id="provinsi"
                                        value="<?php echo e(old('provinsi', $profil->provinsi ?? 'Kalimantan Timur')); ?>"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <textarea name="alamat_kantor" id="alamat_kantor" rows="2"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"><?php echo e(old('alamat_kantor', $profil->alamat_kantor ?? '')); ?></textarea>
                            </div>
                        ...
                        <div x-show="activeTab === 'visi-misi'" class="space-y-6">
                            <div>
                                ...
                                <textarea name="visi" id="visi" rows="4"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"><?php echo e(old('visi', $profil->visi ?? '')); ?></textarea>
                            </div>
                            <div>
                                <label for="misi" class="block text-sm font-medium text-gray-700 mb-1">Misi</label>
                                <textarea name="misi" id="misi" rows="8"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                    placeholder="Gunakan format list dengan tanda - atau nomor untuk setiap poin misi"><?php echo e(old('misi', $profil->misi ?? '')); ?></textarea>
                        ...
                        <div x-show="activeTab === 'geografis'" class="space-y-6">
                            <div class="grid md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="luas_wilayah" id="luas_wilayah"
                                        value="<?php echo e(old('luas_wilayah', $profil->luas_wilayah ?? '')); ?>"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="ketinggian" id="ketinggian"
                                        value="<?php echo e(old('ketinggian', $profil->ketinggian ?? '')); ?>"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                </div>
                                <div>
                                    <label for="jumlah_dusun" class="block text-sm font-medium text-gray-700 mb-1">Jumlah Dusun</label>
                                    <input type="number" id="jumlah_dusun"
                                        value="<?php echo e($profil->jumlah_dusun ?? '4'); ?>" readonly
                                        class="w-full px-4 py-2 border border-gray-200 bg-gray-50 text-gray-500 rounded-lg cursor-not-allowed">
                                    <p class="mt-1 text-[10px] text-gray-400 italic">* Otomatis dari data Wilayah/Dusun</p>
                                </div>
                            </div>
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="batas_utara" id="batas_utara"
                                        value="<?php echo e(old('batas_utara', $profil->batas_utara ?? '')); ?>"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="batas_timur" id="batas_timur"
                                        value="<?php echo e(old('batas_timur', $profil->batas_timur ?? '')); ?>"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                </div>
                            </div>
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="batas_selatan" id="batas_selatan"
                                        value="<?php echo e(old('batas_selatan', $profil->batas_selatan ?? '')); ?>"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="batas_barat" id="batas_barat"
                                        value="<?php echo e(old('batas_barat', $profil->batas_barat ?? '')); ?>"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="koordinat" id="koordinat"
                                    value="<?php echo e(old('koordinat', $profil->koordinat ?? '')); ?>"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                            ...
                            <div>
                                <label for="peta_desa_iframe" class="block text-sm font-medium text-gray-700 mb-1">Embed Peta (Iframe Google Maps)</label>
                                <textarea name="peta_desa_iframe" id="peta_desa_iframe" rows="4"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                    placeholder="Tempel kode iframe dari Google Maps di sini"><?php echo e(old('peta_desa_iframe', $profil->peta_desa ?? '')); ?></textarea>
                                <p class="mt-1 text-sm text-gray-500">Jika diisi, peta ini akan digunakan menggantikan titik koordinat di atas.</p>
                            </div>
                        </div>
                        ...
                        <div x-show="activeTab === 'sejarah'" class="space-y-6">
                            <div>
                                ...
                                <textarea name="sejarah" id="sejarah" rows="15"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"><?php echo e(old('sejarah', $profil->sejarah ?? '')); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div x-show="activeTab === 'media'" class="space-y-6">
                            <!-- Logo -->
                            <div x-data="{ preview: '<?php echo e(isset($profil) && $profil->logo ? Storage::url($profil->logo) : ''); ?>' }">
                            ...
                            <!-- Foto Kantor -->
                            <div x-data="{ preview: '<?php echo e(isset($profil) && $profil->foto_kantor ? Storage::url($profil->foto_kantor) : ''); ?>' }">
                            ...
                            <!-- Struktur Organisasi -->
                            <div x-data="{ preview: '<?php echo e(isset($profil) && $profil->struktur_organisasi ? Storage::url($profil->struktur_organisasi) : ''); ?>' }">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-desa-tanalum\resources\views/admin/profil-desa/index.blade.php ENDPATH**/ ?>