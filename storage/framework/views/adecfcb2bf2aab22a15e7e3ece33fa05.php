...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative">
        <div x-data="{
            activeSlide: 0,
            slides: <?php echo e($sliders->count()); ?>,
            autoPlay: null,
            init() {
            ...
            <?php $__empty_1 = true; $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div x-show="activeSlide === <?php echo e($index); ?>" x-transition:enter="transition ease-out duration-500"
                    ...
                    <div class="absolute inset-0 flex items-center">
                        <div class="container mx-auto px-6 md:px-12 lg:px-20 md:px-8 lg:px-16">
                            <div class="max-w-2xl text-white ml-4 md:ml-8 lg:ml-16">
                                <?php if($slider->judul): ?>
                                    <h2 class="text-3xl md:text-5xl font-bold mb-4"><?php echo e($slider->judul); ?></h2>
                                <?php endif; ?>
                                <?php if($slider->deskripsi): ?>
                                    <p class="text-lg md:text-xl mb-6 text-gray-200"><?php echo e($slider->deskripsi); ?></p>
                                <?php endif; ?>
                                <?php if($slider->link): ?>
                    ...
                    <div class="container mx-auto px-6 md:px-12 lg:px-20 md:px-8 lg:px-16">
                        <div class="max-w-2xl text-white ml-4 md:ml-8 lg:ml-16">
                            <h2 class="text-3xl md:text-5xl font-bold mb-4">Selamat Datang di
                                <?php echo e($profil->nama_desa ?? 'Desa Tanalum'); ?></h2>
                            <p class="text-lg md:text-xl mb-6 text-gray-100"><?php echo e($profil->kecamatan ?? 'Kec. Marang Kayu'); ?>,
                                <?php echo e($profil->kabupaten ?? 'Kab. Kutai Kartanegara'); ?></p>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
                ...
                <div class="absolute bottom-6 left-1/2 -translate-x-1/2 flex space-x-2">
                    <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button @click="activeSlide = <?php echo e($index); ?>"
                            :class="{
                                'bg-white': activeSlide === <?php echo e($index); ?>,
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div data-aos="fade-left">
                    ...
                    <p class="text-gray-600 leading-relaxed mb-6">
                        <?php echo e(Str::limit($profil->sejarah ?? 'Desa Tanalum merupakan salah satu desa yang terletak di Kecamatan Marang Kayu, Kabupaten Kutai Kartanegara, Provinsi Kalimantan Timur. Desa ini memiliki potensi alam yang melimpah dan masyarakat yang ramah.', 300)); ?>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-800"><?php echo e($profil->kecamatan ?? 'Rembang'); ?></p>
                            </div>
                        </div>
                        <div class="flex items-center">
                            <div class="w-10 h-10 bg-primary-100 rounded-lg flex items-center justify-center mr-3">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-800"><?php echo e($profil->kabupaten ?? 'Purbalingga'); ?></p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                    <div class="text-center order-1" data-aos="fade-right">
                        ...
                        <?php if($logo && Storage::disk('public')->exists($logo)): ?>
                            <img src="<?php echo e(Storage::url($logo)); ?>" alt="Logo <?php echo e($profil->nama_desa ?? 'Desa Tanalum'); ?>"
                    ...
                    <div class="text-center lg:text-left order-2" data-aos="fade-left">
                        ...
                        <h2 class="text-3xl md:text-4xl font-bold mt-2 mb-6"><?php echo e($kepalaDesa->nama); ?></h2>
                        <p class="text-primary-100 leading-relaxed mb-6">
                            "Selamat datang di website resmi <?php echo e($profil->nama_desa ?? 'Desa Tanalum'); ?>. Website ini hadir
                        ...
                        <div class="flex items-center justify-center lg:justify-start space-x-4">
                            <div>
                                <p class="font-bold text-lg"><?php echo e($kepalaDesa->nama); ?></p>
                                <p class="text-primary-200"><?php echo e($kepalaDesa->jabatan); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="p-6">
                            <div class="flex items-center space-x-4 text-sm text-gray-500 mb-3">
                                <span><i class="far fa-calendar mr-1"></i>
                                    <?php echo e($berita->published_at ? $berita->published_at->format('d M Y') : $berita->created_at->format('d M Y')); ?></span>
                                <?php if($berita->kategori): ?>
                                    <span
                                        class="px-2 py-0.5 bg-primary-100 text-primary-700 rounded text-xs"><?php echo e($berita->kategori->nama); ?></span>
                                <?php endif; ?>
                            </div>
                            <h3
                            ...
                            <p class="text-gray-600 text-sm line-clamp-3">
                                <?php echo e($berita->ringkasan ?? Str::limit(strip_tags($berita->konten), 120)); ?></p>
                        </div>
                    </article>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <section class="py-16">
        <div class="container mx-auto px-6 md:px-12 lg:px-20">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <a href="<?php echo e(route('infografis.penduduk')); ?>" class="group" data-aos="fade-up" data-aos-delay="0">
                    <div
                ...
                <a href="<?php echo e(route('infografis.apbdes')); ?>" class="group" data-aos="fade-up" data-aos-delay="100">
                    <div
                ...
                <a href="<?php echo e(route('infografis.idm')); ?>" class="group" data-aos="fade-up" data-aos-delay="200">
                    <div
                ...
                <a href="<?php echo e(route('infografis.sdgs')); ?>" class="group" data-aos="fade-up" data-aos-delay="300">
                    <div
                ...
                <a href="<?php echo e(route('infografis.bansos')); ?>" class="group" data-aos="fade-up" data-aos-delay="400">
                    <div
                ...
                <a href="<?php echo e(route('cek-bansos')); ?>" class="group" data-aos="fade-up" data-aos-delay="500">
                    <div
                    ...
                    <?php $__currentLoopData = $produks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white rounded-2xl shadow-sm overflow-hidden hover:shadow-lg transition group"
                            ...
                            <div class="p-5">
                                ...
                                <p class="text-primary-600 font-bold text-lg mt-2"><?php echo e($produk->formatted_harga); ?></p>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
        ...
        <section class="py-16 bg-gray-50">
            <div class="container mx-auto px-6 md:px-12 lg:px-20">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                    <?php $__currentLoopData = $aparaturs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $aparatur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="text-center" data-aos="fade-up" data-aos-delay="<?php echo e($index * 100); ?>">
                            <div
                            ...
                            <h3 class="font-semibold text-gray-800"><?php echo e($aparatur->nama); ?></h3>
                            <p class="text-sm text-gray-500"><?php echo e($aparatur->jabatan); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-desa-tanalum\resources\views/home.blade.php ENDPATH**/ ?>