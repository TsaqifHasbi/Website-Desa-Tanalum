...
<body class="min-h-screen bg-gradient-to-br from-primary-600 to-primary-800 flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div class="text-center mb-8">
                <div class="w-20 h-20 flex items-center justify-center mx-auto mb-4">
                    <img src="<?php echo e(asset('storage/slider/logo-tanalum.png')); ?>" alt="Logo Tanalum"
            ...
            <div class="mt-6 text-center">
                <a href="<?php echo e(route('home')); ?>" class="text-sm text-gray-500 hover:text-primary-600 transition">
        ...
        <p class="text-center text-white/60 text-sm mt-6">
            &copy; <?php echo e(date('Y')); ?> Desa Tanalum. All rights reserved.
        </p>
    </div>
...
<?php /**PATH C:\laragon\www\website-desa-tanalum\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>