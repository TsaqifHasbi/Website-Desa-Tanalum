...
<?php $__env->startSection('content'); ?>
    <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800"><?php echo e(number_format($statistik['total'] ?? 0)); ?></p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-xl shadow-sm p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800"><?php echo e(number_format($statistik['laki_laki'] ?? 0)); ?></p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-xl shadow-sm p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800"><?php echo e(number_format($statistik['perempuan'] ?? 0)); ?></p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-xl shadow-sm p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800"><?php echo e(number_format($statistik['kk'] ?? 0)); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Form Update -->
        <form action="<?php echo e(route('admin.data.penduduk.update')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                ...
                <div class="bg-white rounded-xl shadow-sm">
                    ...
                    <div class="p-6">
                            ...
                            <div class="grid md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="number" name="gender[laki_laki]"
                                        value="<?php echo e(old('gender.laki_laki', $data['gender']['laki_laki'] ?? 0)); ?>"
                                        min="0"
                                ...
                                <div>
                                    ...
                                    <input type="number" name="gender[perempuan]"
                                        value="<?php echo e(old('gender.perempuan', $data['gender']['perempuan'] ?? 0)); ?>"
                                        min="0"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                </div>
                                <div>
                                    ...
                                    <input type="number" name="gender[kk]"
                                        value="<?php echo e(old('gender.kk', $data['gender']['kk'] ?? 0)); ?>" min="0"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                </div>
                            </div>
                        </div>
                        ...
                        <div x-show="activeTab === 'age'">
                            <div class="grid md:grid-cols-3 gap-6">
                                ...
                                ?>
                                <?php $__currentLoopData = $ageGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($group); ?>

                                            Tahun</label>
                                        <input type="number" name="age[<?php echo e($group); ?>]"
                                            value="<?php echo e(old('age.' . $group, $data['age'][$group] ?? 0)); ?>" min="0"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                    </div>
                        ...
                        <div x-show="activeTab === 'education'">
                            <div class="grid md:grid-cols-3 gap-6">
                                ...
                                <?php $__currentLoopData = $educations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $edu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($edu); ?></label>
                                        <input type="number" name="education[<?php echo e($edu); ?>]"
                                            value="<?php echo e(old('education.' . $edu, $data['education'][$edu] ?? 0)); ?>"
                                            min="0"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div x-show="activeTab === 'occupation'">
                            <div class="grid md:grid-cols-3 gap-6">
                                ...
                                <?php $__currentLoopData = $occupations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $occ): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($occ); ?></label>
                                        <input type="number" name="occupation[<?php echo e($occ); ?>]"
                                            value="<?php echo e(old('occupation.' . $occ, $data['occupation'][$occ] ?? 0)); ?>"
                                            min="0"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div x-show="activeTab === 'religion'">
                            <div class="grid md:grid-cols-3 gap-6">
                                ...
                                <?php $__currentLoopData = $religions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 mb-1"><?php echo e($rel); ?></label>
                                        <input type="number" name="religion[<?php echo e($rel); ?>]"
                                            value="<?php echo e(old('religion.' . $rel, $data['religion'][$rel] ?? 0)); ?>"
                                            min="0"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div
                        ...
                        <p class="text-sm text-gray-500">
                            ...
                            Terakhir diupdate: <?php echo e($lastUpdated ?? '-'); ?>
        ...
        <div class="absolute inset-0 flex items-center justify-center p-4">
            <div class="bg-white rounded-xl shadow-xl max-w-md w-full">
                <div class="p-6">
                    ...
                    <form action="<?php echo e(route('admin.data.penduduk.import')); ?>" method="POST"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-desa-tanalum\resources\views/admin/data-desa/penduduk.blade.php ENDPATH**/ ?>