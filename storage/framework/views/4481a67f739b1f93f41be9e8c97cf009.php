                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-6" data-aos="fade-left" data-aos-delay="100">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between">
                                ...
                                <span
                                    class="font-medium text-gray-800"><?php echo e($profil->luas_wilayah ? number_format($profil->luas_wilayah, 2) . ' Km²' : '-'); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500">Jumlah Dusun</span>
                                <span class="font-medium text-gray-800"><?php echo e($profil->jumlah_dusun ?? '-'); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500">Jumlah RT</span>
                                <span class="font-medium text-gray-800"><?php echo e($profil->jumlah_rt ?? '-'); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500">Jumlah RW</span>
                                <span class="font-medium text-gray-800"><?php echo e($profil->jumlah_rw ?? '-'); ?></span>
                            </div>
                        </div>
