    ...
    <section class="relative py-20 bg-gradient-to-r from-primary-600 to-primary-700">
        <div class="container mx-auto px-4">
            <div class="text-center text-white">
                ...
                <p class="text-lg text-primary-100"><?php echo e($profil->nama_desa ?? 'Desa Tanalum'); ?>,
                    <?php echo e($profil->kecamatan ?? 'Kec. Marang Kayu'); ?></p>
            </div>
        </div>
    </section>
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-8" data-aos="fade-up">
                        <h2 class="text-2xl font-bold text-gray-800 mb-6">Tentang <?php echo e($profil->nama_desa ?? 'Desa Tanalum'); ?>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-8" data-aos="fade-up">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="bg-primary-50 rounded-xl p-4 text-gray-700">
                                <?php echo $profil->visi ?? '<p>Terwujudnya Desa Tanalum yang maju, mandiri, dan sejahtera</p>'; ?>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-800">
                                        <?php echo e($profil->alamat ?? 'Desa Tanalum, Kec. Marang Kayu, Kab. Kutai Kartanegara'); ?>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-800"><?php echo e($profil->telepon ?? '-'); ?></p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-3">
                                <div
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-800"><?php echo e($profil->email ?? '-'); ?></p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-3">
                                <div
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-800"><?php echo e($profil->kode_desa ?? '-'); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-6" data-aos="fade-left" data-aos-delay="100">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between">
                                ...
                                <span
                                    class="font-medium text-gray-800"><?php echo e($profil->luas_wilayah ? number_format($profil->luas_wilayah, 2) . ' Ha' : '-'); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500">Jumlah Dusun</span>
                                <span class="font-medium text-gray-800"><?php echo e($profil->jumlah_dusun ?? '4'); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500">Jumlah RT</span>
                                <span class="font-medium text-gray-800"><?php echo e($profil->jumlah_rt ?? '20'); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500">Jumlah RW</span>
                                <span class="font-medium text-gray-800"><?php echo e($profil->jumlah_rw ?? '4'); ?></span>
                            </div>
                        </div>
        ...
        <section class="py-16 bg-gray-50">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12" data-aos="fade-up">
                    ...
                    <p class="text-gray-600 mt-2">Perangkat Pemerintahan <?php echo e($profil->nama_desa ?? 'Desa Tanalum'); ?></p>
                </div>

                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    <?php $__currentLoopData = $aparaturs->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $aparatur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-desa-tanalum\resources\views/profil/index.blade.php ENDPATH**/ ?>