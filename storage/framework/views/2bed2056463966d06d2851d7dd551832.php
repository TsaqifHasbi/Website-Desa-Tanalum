    ...
    <div class="flex items-center justify-between h-16 px-4 lg:px-6">
        ...
        <div class="flex items-center">
            ...
            <nav class="hidden md:flex items-center text-sm text-gray-500">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="hover:text-primary-600">Dashboard</a>
        ...
        <div class="flex items-center space-x-4">
            ...
            <div x-data="{ open: false }" class="relative">
                <button @click="open = !open"
                    ...
                    <?php if($notifCount > 0): ?>
                        <span
                            class="absolute top-0 right-0 w-4 h-4 bg-red-500 text-white text-xs rounded-full flex items-center justify-center"><?php echo e($notifCount > 9 ? '9+' : $notifCount); ?></span>
                    <?php endif; ?>
                </button>
                ...
                <div x-show="open" @click.away="open = false" x-cloak
                    ...
                    <div class="max-h-64 overflow-y-auto">
                        <?php $pengaduanBaru = App\Models\Pengaduan::where('status', 'baru')->latest()->take(3)->get(); ?>
                        <?php $__empty_1 = true; $__currentLoopData = $pengaduanBaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <a href="<?php echo e(route('admin.pengaduan.show', $p)); ?>"
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-800 line-clamp-1"><?php echo e($p->judul); ?>

                                        </p>
                                        <p class="text-xs text-gray-500"><?php echo e($p->created_at->diffForHumans()); ?></p>
                                    </div>
                                </div>
                            </a>
            ...
            <div x-data="{ open: false }" class="relative">
                <button @click="open = !open" class="flex items-center space-x-2 p-1.5 hover:bg-gray-100 rounded-lg">
                    ...
                    <?php else: ?>
                        <div class="w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center">
                            <span
                                class="text-primary-700 font-semibold text-sm"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></span>
                        </div>
                    <?php endif; ?>
                ...
                <div x-show="open" @click.away="open = false" x-cloak
                    ...
                    <div class="px-4 py-2 border-b border-gray-100">
                        ...
                        <p class="text-xs text-gray-500"><?php echo e(Auth::user()->getRoleLabel()); ?></p>
                    </div>
...
<?php /**PATH C:\laragon\www\website-desa-tanalum\resources\views/admin/partials/topnav.blade.php ENDPATH**/ ?>