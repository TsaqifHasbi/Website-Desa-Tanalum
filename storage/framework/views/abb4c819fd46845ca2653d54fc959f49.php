...
<?php $__env->startSection('title', 'Kategori PPID'); ?>
...
<?php $__env->startSection('content'); ?>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-600"><?php echo e($kategori->urutan ?? '-'); ?></td>
                                <td class="px-6 py-4">
                                    <div>
                                        <span class="font-medium text-gray-800"><?php echo e($kategori->nama); ?></span>
                                        <?php if($kategori->deskripsi): ?>
                                            <p class="text-sm text-gray-500 line-clamp-1"><?php echo e($kategori->deskripsi); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    ...
                                    ?>
                                    <span class="px-3 py-1 rounded-full text-sm <?php echo e($jenis['class']); ?>">
                                        <?php echo e($jenis['label']); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4">
                                    <span class="px-3 py-1 bg-primary-100 text-primary-700 rounded-full text-sm">
                                        <?php echo e($kategori->dokumen_count ?? 0); ?> dokumen
                                    </span>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <button type="button" onclick="openEditModal(<?php echo e(json_encode($kategori)); ?>)"
                                            class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition" title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <form action="<?php echo e(route('admin.ppid.kategori.destroy', $kategori)); ?>" method="POST"
                                            class="inline"
    ...
    <div id="addModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center">
        <div class="bg-white rounded-xl shadow-xl w-full max-w-lg mx-4">
            ...
            <form action="<?php echo e(route('admin.ppid.kategori.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function openEditModal(kategori) {
            ...
            document.getElementById('editForm').action = '<?php echo e(url('admin/ppid/kategori')); ?>/' + kategori.id;
            openModal('editModal');
        }
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-desa-tanalum\resources\views/admin/ppid/kategori.blade.php ENDPATH**/ ?>