        ...
        <div class="container mx-auto px-4">
            <?php if($idm): ?>
                ...
                <div class="grid lg:grid-cols-2 gap-8 mb-8">
                    <div class="bg-white rounded-2xl shadow-sm p-6" data-aos="fade-up">
                        <h3 class="text-xl font-bold text-gray-800 mb-6">Progres IDM Tahunan</h3>
    ...
    <?php if($idm): ?>
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                // IDM History Chart
                const historyCtx = document.getElementById('idmHistoryChart').getContext('2d');
                new Chart(historyCtx, {
                    ...
                    options: {
                        ...
                        scales: {
                            y: { beginAtZero: false, min: 0.4 }
                        }
                    }
                });

                // IDM Component Chart
                const componentCtx = document.getElementById('idmChart').getContext('2d');
