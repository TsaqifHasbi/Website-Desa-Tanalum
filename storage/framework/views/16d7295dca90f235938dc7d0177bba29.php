    ...
    <section id="cerita-rakyat" class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $ceritaRakyat ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cerita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-white rounded-2xl shadow-sm overflow-hidden mb-8" data-aos="fade-up" data-aos-delay="<?php echo e($index * 100); ?>">
                        <?php if($cerita->gambar_utama): ?>
                            <div class="relative h-64 md:h-80 overflow-hidden">
                                ...
                                <div class="absolute bottom-0 left-0 right-0 p-6 text-white">
                                    <h3 class="text-2xl md:text-3xl font-bold"><?php echo e($cerita->judul); ?></h3>
                                </div>
                            </div>
                        <?php else: ?>
                ...
                <?php if(count($kepalaDesa ?? []) > 0): ?>
                    <div class="relative pt-8">
                        ...
                        <div class="space-y-12 md:space-y-24">
                            <?php $__currentLoopData = $kepalaDesa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $kepala): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="relative flex flex-col md:flex-row items-center w-full" data-aos="fade-up">
                                    ...
                                    <div class="flex flex-col md:flex-row items-center w-full md:gap-0 pl-10 md:pl-0">
                                        ...
                                        <div class="w-full md:w-[45%] <?php echo e($index % 2 == 0 ? 'md:order-1' : 'md:order-3'); ?>">
                                            <div class="bg-white rounded-3xl shadow-md hover:shadow-xl transition-all duration-500 overflow-hidden border border-gray-100 group">
                                                <div class="flex flex-col sm:flex-row h-full">
                                                    ...
                                                    <div class="w-full sm:w-40 md:w-48 h-64 sm:h-auto shrink-0 relative overflow-hidden">
                                                        <?php if($kepala->foto): ?>
                                                            <img src="<?php echo e(Storage::url($kepala->foto)); ?>" 
                                                                alt="<?php echo e($kepala->nama); ?>"
                                                    ...
                                                    <div class="p-6 flex-1 flex flex-col justify-center">
                                                        <span class="text-xs font-bold text-primary-600 uppercase tracking-widest mb-2 block">Kepala Desa <?php echo e($index + 1); ?></span>
                                                        <h3 class="text-xl md:text-2xl font-bold text-gray-900 mb-2 leading-tight"><?php echo e($kepala->nama); ?></h3>
                                                        ...
                                                        <?php if($kepala->keterangan): ?>
                                                            <p class="text-gray-600 text-sm italic line-clamp-3">"<?php echo e($kepala->keterangan); ?>"</p>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="hidden md:block w-[45%] <?php echo e($index % 2 == 0 ? 'order-3' : 'order-1'); ?>"></div>
                                    </div>
                                </div>
