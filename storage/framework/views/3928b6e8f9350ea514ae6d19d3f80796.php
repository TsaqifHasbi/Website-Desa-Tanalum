...
<?php $__env->startSection('title', 'Manajemen Wisata'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <a href="<?php echo e(route('admin.wisata.create')); ?>"
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-16 h-16 rounded-lg overflow-hidden bg-gray-100 mr-4 flex-shrink-0">
                                            <?php if($wisata->gambar_utama): ?>
                                                <img src="<?php echo e(Storage::url($wisata->gambar_utama)); ?>"
                                                    alt="<?php echo e($wisata->nama); ?>" class="w-full h-full object-cover">
                                            <?php else: ?>
                                        ...
                                        <div>
                                            <p class="font-medium text-gray-800"><?php echo e($wisata->nama); ?></p>
                                ...
                                <td class="px-6 py-4">
                                    <?php if($wisata->kategori): ?>
                                        <span
                                            class="px-3 py-1 bg-blue-100 text-blue-700 text-sm font-medium rounded-full"><?php echo e($wisata->kategori); ?></span>
                                    <?php else: ?>
                                        <span class="text-gray-400">-</span>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4">
                                    <p class="text-gray-600 text-sm"><?php echo e($wisata->lokasi ?? '-'); ?></p>
                                </td>
                                <td class="px-6 py-4">
                                    <?php if($wisata->is_active): ?>
                                        <span
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="<?php echo e(route('admin.wisata.edit', $wisata->id)); ?>"
                                            class="p-2 text-gray-500 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition"
                                            title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="<?php echo e(route('admin.wisata.destroy', $wisata->id)); ?>" method="POST"
            ...
            <?php if($wisatas->hasPages()): ?>
                <div class="px-6 py-4 border-t border-gray-200">
                    <?php echo e($wisatas->withQueryString()->links()); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-desa-tanalum\resources\views/admin/wisata/index.blade.php ENDPATH**/ ?>