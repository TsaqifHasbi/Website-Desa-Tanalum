    ...
    <section class="py-12 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="mb-8">
                ...
                <p class="text-gray-600">Update terakhir <?php echo e(now()->diffForHumans()); ?></p>
            </div>
            ...
            <div class="space-y-4">
                <?php $__empty_1 = true; $__currentLoopData = $allDokumens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dokumen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
