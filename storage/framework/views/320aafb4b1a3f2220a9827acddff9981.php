    ...
    <section class="relative py-20 bg-gradient-to-r from-blue-600 to-blue-700">
        <div class="container mx-auto px-4">
            <div class="text-center text-white">
                ...
                <p class="text-lg text-blue-100">Statistik Kependudukan <?php echo e($profil->nama_desa ?? 'Desa Tanalum'); ?></p>
            </div>
        </div>
    </section>
            ...
            <?php if($penduduk): ?>
                ...
                <div class="grid md:grid-cols-4 gap-6 mb-12">
                    <div class="bg-white rounded-2xl shadow-sm p-6 text-center" data-aos="fade-up">
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e(number_format($penduduk->jumlah_penduduk)); ?></p>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-6 text-center" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e(number_format($penduduk->jumlah_laki_laki)); ?></p>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-6 text-center" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e(number_format($penduduk->jumlah_perempuan)); ?></p>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-6 text-center" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e(number_format($penduduk->jumlah_kk)); ?></p>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="flex items-center">
                                ...
                                <span class="text-gray-600">Laki-laki:
                                    <?php echo e(number_format($penduduk->jumlah_laki_laki)); ?></span>
                            </div>
                            <div class="flex items-center">
                                <div class="w-4 h-4 bg-pink-500 rounded-full mr-2"></div>
                                <span class="text-gray-600">Perempuan:
                                    <?php echo e(number_format($penduduk->jumlah_perempuan)); ?></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm p-6 mt-8" data-aos="fade-up">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <tr>
                                    ...
                                    <td class="py-3 px-4 text-right text-gray-800">
                                        <?php echo e(number_format($penduduk->jumlah_laki_laki)); ?></td>
                                    <td class="py-3 px-4 text-right text-gray-500">
                                        <?php echo e($penduduk->jumlah_penduduk > 0 ? number_format(($penduduk->jumlah_laki_laki / $penduduk->jumlah_penduduk) * 100, 1) : 0); ?>%
                                    </td>
                                </tr>
                                <tr>
                                    <td class="py-3 px-4 text-gray-800">Perempuan</td>
                                    <td class="py-3 px-4 text-right text-gray-800">
                                        <?php echo e(number_format($penduduk->jumlah_perempuan)); ?></td>
                                    <td class="py-3 px-4 text-right text-gray-500">
                                        <?php echo e($penduduk->jumlah_penduduk > 0 ? number_format(($penduduk->jumlah_perempuan / $penduduk->jumlah_penduduk) * 100, 1) : 0); ?>%
                                    </td>
                                </tr>
                                <tr class="bg-gray-50 font-semibold">
                                    <td class="py-3 px-4 text-gray-800">Total</td>
                                    <td class="py-3 px-4 text-right text-gray-800">
                                        <?php echo e(number_format($penduduk->jumlah_penduduk)); ?></td>
                    ...
                    <p class="text-sm text-gray-500 mt-4">
                        ...
                        Data terakhir diperbarui: <?php echo e($penduduk->updated_at->format('d M Y')); ?>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                new Chart(document.getElementById('genderChart'), {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: [<?php echo e($penduduk->jumlah_laki_laki); ?>,
                                <?php echo e($penduduk->jumlah_perempuan); ?>
                ...
                new Chart(document.getElementById('ageChart'), {
                    type: 'bar',
                    data: {
                        labels: <?php echo json_encode(array_keys($usia)); ?>,
                        datasets: [{
                            label: 'Jumlah',
                            data: <?php echo json_encode(array_values($usia)); ?>,
                ...
                new Chart(document.getElementById('occupationChart'), {
                    type: 'bar',
                    data: {
                        labels: <?php echo json_encode(array_keys($pekerjaan)); ?>,
                        datasets: [{
                            label: 'Jumlah',
                            data: <?php echo json_encode(array_values($pekerjaan)); ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-desa-tanalum\resources\views/infografis/penduduk.blade.php ENDPATH**/ ?>