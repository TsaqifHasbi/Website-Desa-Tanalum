...
unset($__errorArgs, $__bag); ?>
                    ...
                    <!-- File Upload -->
                    <div x-data="{
                        preview: '<?php echo e($galeri && $galeri->file_path ? Storage::url($galeri->file_path) : ''); ?>',
                        tipe: '<?php echo e(old('tipe', $galeri->tipe ?? 'foto')); ?>'
                    }">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div x-show="tipe === 'video'" x-data="{ tipe: '<?php echo e(old('tipe', $galeri->tipe ?? 'foto')); ?>' }">
