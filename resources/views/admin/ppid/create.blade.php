...
@section('content')
    ...
    <div class="max-w-3xl">
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <form
                action="{{ isset($dokumen) ? route('admin.ppid.dokumen.update', $dokumen) : route('admin.ppid.dokumen.store') }}"
                            ...
                            <div class="mb-4 p-4 bg-gray-50 rounded-lg flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">{{ number_format($dokumen->file_size / 1024, 0) }}
                                            KB</p>
                                    </div>
                                </div>
