...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">{{ $produk ? 'Edit Produk' : 'Tambah Produk' }}</h1>
                <p class="text-gray-600">{{ $produk ? 'Perbarui data produk UMKM' : 'Tambah produk UMKM baru' }}</p>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm">
            <form action="{{ $produk ? route('admin.produk.update', $produk->id) : route('admin.produk.store') }}"
                ...
                <div class="p-6 space-y-6">
                    <div class="grid lg:grid-cols-3 gap-6">
                        <!-- Left Column - Image -->
                        <div>
                            <div x-data="{ preview: '{{ $produk && $produk->gambar_utama ? Storage::url($produk->gambar_utama) : '' }}' }">
                        ...
                        <div class="grid md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="kontak_pemilik" id="kontak_pemilik"
                                    value="{{ old('kontak_pemilik', $produk->kontak_pemilik ?? '') }}"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                            ...
                            <div>
                                ...
                                <input type="text" name="alamat_pemilik" id="alamat_pemilik"
                                    value="{{ old('alamat_pemilik', $produk->alamat_pemilik ?? '') }}"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
