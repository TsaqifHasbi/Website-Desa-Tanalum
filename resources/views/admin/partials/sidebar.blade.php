...
<aside :class="{ '-translate-x-full': !sidebarOpen }"
    ...
    <nav class="p-4 space-y-1 overflow-y-auto h-[calc(100vh-4rem)]">
        ...
        <a href="{{ route('admin.sejarah.index') }}"
            class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg {{ request()->routeIs('admin.sejarah.*') ? 'bg-primary-50 text-primary-700' : 'text-gray-700 hover:bg-gray-50' }}">
