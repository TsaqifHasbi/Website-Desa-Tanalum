        ...
        <div class="container mx-auto px-4">
            @if ($idm)
                ...
                <div class="bg-white rounded-2xl shadow-sm p-8 mb-8 text-center" data-aos="fade-up">
                    ...
                    @endphp
                    <span
                        class="inline-block px-6 py-2 rounded-full text-lg font-semibold {{ $statusColors[$idm->status_idm] ?? 'bg-gray-100 text-gray-700' }}">
                        DESA {{ strtoupper(str_replace('_', ' ', $idm->status_idm)) }}
                    </span>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-6 mb-12">
                    <div class="bg-white rounded-2xl shadow-sm p-6" data-aos="fade-up">
                        <div class="text-center">
                            ...
                            <p class="text-4xl font-bold text-blue-600">{{ $idm->iks ? number_format($idm->iks, 4) : '-' }}
                            </p>
                        </div>
                    </div>
                    <div class="bg-white rounded-2xl shadow-sm p-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="text-center">
                            ...
                            <p class="text-4xl font-bold text-green-600">
                                {{ $idm->ike ? number_format($idm->ike, 4) : '-' }}</p>
                        </div>
                    </div>
                    <div class="bg-white rounded-2xl shadow-sm p-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="text-center">
                            ...
                            <p class="text-4xl font-bold text-orange-600">
                                {{ $idm->ikl ? number_format($idm->ikl, 4) : '-' }}</p>
                        </div>
                    </div>
                </div>
