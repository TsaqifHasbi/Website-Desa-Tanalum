                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-6" data-aos="fade-left" data-aos-delay="100">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between">
                                ...
                                <span
                                    class="font-medium text-gray-800">{{ $profil->luas_wilayah ? number_format($profil->luas_wilayah, 2) . ' Ha' : '-' }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500">Jumlah Dusun</span>
                                <span class="font-medium text-gray-800">{{ $profil->jumlah_dusun ?? '4' }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500">Jumlah RT</span>
                                <span class="font-medium text-gray-800">{{ $profil->jumlah_rt ?? '20' }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500">Jumlah RW</span>
                                <span class="font-medium text-gray-800">{{ $profil->jumlah_rw ?? '4' }}</span>
                            </div>
                        </div>
