        ...
        <div class="container mx-auto px-4 overflow-x-auto">
            ...
            <div class="org-chart">
                ...
                <div class="org-box bg-kades" style="left: 440px; top: 0; width: 170px;">
                    ...
                    <div class="name">{{ $kepalaDesa->nama ?? 'Kepala Desa' }}</div>
                    <div class="title">Kepala Desa</div>
                </div>
                
                {{-- Garis Koordinasi ke BPD --}}
                ...
                <div class="org-box bg-sekdes" style="left: 80px; top: 190px; width: 180px;">
                    <div class="photo">
                        @if($sekretaris && $sekretaris->foto)
                            <img src="{{ Storage::url($sekretaris->foto) }}" alt="{{ $sekretaris->nama }}">
                        @else
                            <i class="fas fa-user"></i>
                        @endif
                    </div>
                    <div class="name">{{ $sekretaris->nama ?? 'Sekretaris' }}</div>
                    <div class="title">Sekretaris Desa</div>
                </div>
                
                {{-- Garis dari Sekdes ke Kaur --}}
                ...
                <div class="org-box-sm bg-kaur" style="left: -30px; top: 365px; width: 120px;">
                    <div class="photo">
                        @if(isset($kaur[0]) && $kaur[0]->foto)
                            <img src="{{ Storage::url($kaur[0]->foto) }}" alt="{{ $kaur[0]->nama }}">
                        @else
                            <i class="fas fa-user"></i>
                        @endif
                    </div>
                    <div class="name">{{ $kaur[0]->nama ?? '-' }}</div>
                    <div class="title">{{ $kaur[0]->jabatan ?? 'Kaur TU & Umum' }}</div>
                </div>
                ...
                <div class="org-box-sm bg-kaur" style="left: 110px; top: 365px; width: 120px;">
                    <div class="photo">
                        @if(isset($kaur[1]) && $kaur[1]->foto)
                            <img src="{{ Storage::url($kaur[1]->foto) }}" alt="{{ $kaur[1]->nama }}">
                        @else
                            <i class="fas fa-user"></i>
                        @endif
                    </div>
                    <div class="name">{{ $kaur[1]->nama ?? '-' }}</div>
                    <div class="title">{{ $kaur[1]->jabatan ?? 'Kaur Keuangan' }}</div>
                </div>
                ...
                <div class="org-box-sm bg-kaur" style="left: 255px; top: 365px; width: 120px;">
                    <div class="photo">
                        @if(isset($kaur[2]) && $kaur[2]->foto)
                            <img src="{{ Storage::url($kaur[2]->foto) }}" alt="{{ $kaur[2]->nama }}">
                        @else
                            <i class="fas fa-user"></i>
                        @endif
                    </div>
                    <div class="name">{{ $kaur[2]->nama ?? '-' }}</div>
                    <div class="title">{{ $kaur[2]->jabatan ?? 'Kaur Perencanaan' }}</div>
                </div>
                ...
                <div class="org-box-sm bg-kasi" style="left: 585px; top: 190px; width: 130px;">
                    <div class="photo">
                        @if(isset($kasi[0]) && $kasi[0]->foto)
                            <img src="{{ Storage::url($kasi[0]->foto) }}" alt="{{ $kasi[0]->nama }}">
                        @else
                            <i class="fas fa-user"></i>
                        @endif
                    </div>
                    <div class="name">{{ $kasi[0]->nama ?? '-' }}</div>
                    <div class="title">{{ $kasi[0]->jabatan ?? 'Kasi Pemerintahan' }}</div>
                </div>
                ...
                <div class="org-box-sm bg-kasi" style="left: 725px; top: 190px; width: 130px;">
                    <div class="photo">
                        @if(isset($kasi[1]) && $kasi[1]->foto)
                            <img src="{{ Storage::url($kasi[1]->foto) }}" alt="{{ $kasi[1]->nama }}">
                        @else
                            <i class="fas fa-user"></i>
                        @endif
                    </div>
                    <div class="name">{{ $kasi[1]->nama ?? '-' }}</div>
                    <div class="title">{{ $kasi[1]->jabatan ?? 'Kasi Pelayanan' }}</div>
                </div>
                ...
                <div class="org-box-sm bg-kasi" style="left: 865px; top: 190px; width: 130px;">
                    <div class="photo">
                        @if(isset($kasi[2]) && $kasi[2]->foto)
                            <img src="{{ Storage::url($kasi[2]->foto) }}" alt="{{ $kasi[2]->nama }}">
                        @else
                            <i class="fas fa-user"></i>
                        @endif
                    </div>
                    <div class="name">{{ $kasi[2]->nama ?? '-' }}</div>
                    <div class="title">{{ $kasi[2]->jabatan ?? 'Kasi Kesejahteraan' }}</div>
                </div>
                
                {{-- ═══════════════════════════════════════════════════════════════════ --}}
                {{-- GARIS VERTIKAL KE KADUS (dari titik tengah turun) --}}
                {{-- ═══════════════════════════════════════════════════════════════════ --}}
                ...
                <div class="org-box-sm bg-kadus" style="left: 80px; top: 545px; width: 140px;">
                    <div class="photo">
                        @if(isset($kadus[0]) && $kadus[0]->foto)
                            <img src="{{ Storage::url($kadus[0]->foto) }}" alt="{{ $kadus[0]->nama }}">
                        @else
                            <i class="fas fa-user"></i>
                        @endif
                    </div>
                    <div class="name">{{ $kadus[0]->nama ?? '-' }}</div>
                    <div class="title">{{ $kadus[0]->jabatan ?? 'Kepala Dusun I' }}</div>
                </div>
                ...
                <div class="org-box-sm bg-kadus" style="left: 345px; top: 545px; width: 140px;">
                    <div class="photo">
                        @if(isset($kadus[1]) && $kadus[1]->foto)
                            <img src="{{ Storage::url($kadus[1]->foto) }}" alt="{{ $kadus[1]->nama }}">
                        @else
                            <i class="fas fa-user"></i>
                        @endif
                    </div>
                    <div class="name">{{ $kadus[1]->nama ?? '-' }}</div>
                    <div class="title">{{ $kadus[1]->jabatan ?? 'Kepala Dusun II' }}</div>
                </div>
                ...
                <div class="org-box-sm bg-kadus" style="left: 575px; top: 545px; width: 140px;">
                    <div class="photo">
                        @if(isset($kadus[2]) && $kadus[2]->foto)
                            <img src="{{ Storage::url($kadus[2]->foto) }}" alt="{{ $kadus[2]->nama }}">
                        @else
                            <i class="fas fa-user"></i>
                        @endif
                    </div>
                    <div class="name">{{ $kadus[2]->nama ?? '-' }}</div>
                    <div class="title">{{ $kadus[2]->jabatan ?? 'Kepala Dusun III' }}</div>
                </div>
                ...
                <div class="org-box-sm bg-kadus" style="left: 830px; top: 545px; width: 140px;">
                    <div class="photo">
                        @if(isset($kadus[3]) && $kadus[3]->foto)
                            <img src="{{ Storage::url($kadus[3]->foto) }}" alt="{{ $kadus[3]->nama }}">
                        @else
                            <i class="fas fa-user"></i>
                        @endif
                    </div>
                    <div class="name">{{ $kadus[3]->nama ?? '-' }}</div>
                    <div class="title">{{ $kadus[3]->jabatan ?? 'Kepala Dusun IV' }}</div>
                </div>
